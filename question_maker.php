...
<body>
    ...
    <section class="container">
        ...
        <form action="./question_maker_done.php" method="get">
            ...
            <input type="submit" name="next" value="Create next Question" id="mk_btn">
            <input type="submit" name="finish" value="List all your questions" id="mk_btn" onclick="location.href='./question_maker_list.php'">
        </form>
