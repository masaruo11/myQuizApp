...
INSERT INTO `answer` (`answer_id`, `question`, `correct_answer`, `selected`) VALUES
(1, '', '', ''),
(2, '', '', ''),
(3, '中国の首都は？', '北京', 'sydney'),
(4, '中国の首都は？', '北京', '北京'),
...
(31, '中国の首都は？', '北京', '111', 'sydney', 0, 0),
(33, 'オーストラリアの首都は？', 'キャンベラ', '111', 'パース', 0, 0),
(51, 'dog', 'cat', 'bat', 'put', 0, 0);
...
--
ALTER TABLE `answer`
  MODIFY `answer_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
